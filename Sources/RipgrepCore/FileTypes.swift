...
public struct FileTypeRegistry: Equatable, Sendable {
    ...
    public static let defaultDefinitions: [FileTypeDefinition] = [
        ...
        FileTypeDefinition(name: "hurl", aliases: ["hurl"], globs: ["*.hurl"]),
        ...
        FileTypeDefinition(name: "mojo", aliases: ["mojo"], globs: ["*.mojo"]),
        ...
        FileTypeDefinition(name: "pkgbuild", aliases: ["pkgbuild"], globs: ["PKGBUILD"]),
        ...
        FileTypeDefinition(name: "proto", aliases: ["proto", "protobuf"], globs: ["*.proto"]),
        ...
        FileTypeDefinition(name: "rocq", aliases: ["rocq"], globs: ["*.v"]),
