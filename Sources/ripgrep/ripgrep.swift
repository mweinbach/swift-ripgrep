...
struct RipgrepCommand {
    ...
    private static func runSwiftDarwinLiteralPreflight(arguments: [String]) -> Int32? {
        ...
        if parsedPrintMode == .matchingLines,
           ...
           path != "-",
           isReadableRegularFile(path),
           let exitCode = SwiftDarwinLiteralPreflight.asciiFixedClassMatchedLineOutputExitCode(
            path: path,
            pattern: pattern,
            lineNumber: lineNumber,
            maxCount: parsedMaxCount,
        ...
        if parsedPrintMode == .matchingLines,
           ...
           path != "-",
           isReadableRegularFile(path),
           let exitCode = SwiftDarwinLiteralPreflight.asciiFixedClassMatchedLineStatsExitCode(
            path: path,
            pattern: pattern,
            lineNumber: lineNumber,
            maxCount: parsedMaxCount,
        ...
        if parsedPrintMode == .matchingLines,
           ...
           path != "-",
           isReadableRegularFile(path),
           let exitCode = SwiftDarwinLiteralPreflight.asciiFixedClassVimgrepLineStatsExitCode(
            path: path,
            pattern: pattern,
        ...
        if parsedPrintMode == .matchingLines,
           ...
           path != "-",
           isReadableRegularFile(path),
           let exitCode = SwiftDarwinLiteralPreflight.asciiFixedClassJSONOutputExitCode(
            path: path,
        ...
        if parsedPrintMode == .matchingLines,
           ...
           path != "-",
           isReadableRegularFile(path),
           let exitCode = SwiftDarwinLiteralPreflight.asciiFixedClassOnlyMatchingStatsExitCode(
            path: path,
            pattern: pattern,
        ...
        if parsedPrintMode == .matchingLines,
           ...
           path != "-",
           isReadableRegularFile(path),
           let exitCode = SwiftDarwinLiteralPreflight.asciiFixedClassVimgrepLineOutputExitCode(
            path: path,
            pattern: pattern,
            lineNumber: parsedVimgrepLineNumber,
            byteOffset: parsedByteOffset,
        ...
        if parsedCountStyleOutput,
           ...
           path != "-",
           isReadableRegularFile(path),
           let exitCode = SwiftDarwinLiteralPreflight.asciiFixedClassNoMatchCountOutputExitCode(
            path: path,
            pattern: pattern,
            includeZero: parsedIncludeZero,
            countPrefix: parsedCountPrefix,
        ...
        if parsedStats,
           ...
           path != "-",
           isReadableRegularFile(path),
           let exitCode = SwiftDarwinLiteralPreflight.asciiFixedClassMatchedQuietStatsExitCode(
            path: path,
            pattern: pattern
           ) {
            return exitCode
        ...
        if parsedFilesWithoutMatchPrintModeCanUseNoMatchPreflight,
           ...
           path != "-",
           isReadableRegularFile(path),
           let exitCode = SwiftDarwinLiteralPreflight.asciiFixedClassNoMatchPathOutputExitCode(
            path: path,
            pattern: pattern,
            nullTerminated: parsedNullPathTerminator,
            crlfTerminated: parsedCrlf,
