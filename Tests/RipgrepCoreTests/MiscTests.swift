...
struct MiscTests {
    ...
    @Test("four-byte literal SIMD candidates remain exact")
    func fourByteLiteralSIMDCandidatesRemainExact() throws {
        let root = try TemporaryDirectory()
        try root.write("alpha beta zeta\n", to: "miss.txt")
        try root.write("alpha beta zeta\nbtta exact\n", to: "hit.txt")
    ...
    @Test("five-byte literal SIMD candidates remain exact")
    func fiveByteLiteralSIMDCandidatesRemainExact() throws {
        let root = try TemporaryDirectory()
        try root.write("alpha theta zeta\n", to: "miss.txt")
        try root.write("alpha theta zeta\ntqexa exact\n", to: "hit.txt")
    ...
    @Test("six-byte literal SIMD candidates remain exact")
    func sixByteLiteralSIMDCandidatesRemainExact() throws {
        let root = try TemporaryDirectory()
        try root.write("alpha theta zeta\n", to: "miss.txt")
        try root.write("alpha theta zeta\ntqetq exact\n", to: "hit.txt")
    ...
    @Test("seven-byte literal SIMD candidates remain exact")
    func sevenByteLiteralSIMDCandidatesRemainExact() throws {
        let root = try TemporaryDirectory()
        try root.write("alpha theta zeta\n", to: "miss.txt")
        try root.write("alpha theta zeta\n qqeqq exact\n", to: "hit.txt")
    ...
    @Test("eight-byte literal SIMD candidates remain exact")
    func eightByteLiteralSIMDCandidatesRemainExact() throws {
        let root = try TemporaryDirectory()
        try root.write("alpha beta theta zeta\n", to: "miss.txt")
        try root.write("alpha beta theta zeta\ntqetazqe exact\n", to: "hit.txt")
    ...
    @Test("nine-byte literal SIMD candidates remain exact")
    func nineByteLiteralSIMDCandidatesRemainExact() throws {
        let root = try TemporaryDirectory()
        try root.write("alpha beta theta zeta\n", to: "miss.txt")
        try root.write("alpha beta theta zeta\ntqetazqet exact\n", to: "hit.txt")
    ...
    @Test("ten-byte literal SIMD candidates remain exact")
    func tenByteLiteralSIMDCandidatesRemainExact() throws {
        let root = try TemporaryDirectory()
        try root.write("alpha beta theta zeta\n", to: "miss.txt")
        try root.write("alpha beta theta zeta\ntqeta zqta exact\n", to: "hit.txt")
    ...
    @Test("eleven-byte literal SIMD candidates remain exact")
    func elevenByteLiteralSIMDCandidatesRemainExact() throws {
        let root = try TemporaryDirectory()
        try root.write("alpha beta theta zeta eta\n", to: "miss.txt")
        try root.write("alpha beta theta zeta eta\ntqeta zqta  exact\n", to: "hit.txt")
    ...
    @Test("twelve-byte literal SIMD candidates remain exact")
    func twelveByteLiteralSIMDCandidatesRemainExact() throws {
        let root = try TemporaryDirectory()
        try root.write("alpha beta theta zeta eta\n", to: "miss.txt")
        try root.write("alpha beta theta zeta eta\ntqeta zqta e exact\n", to: "hit.txt")
    ...
    @Test("interior rare-byte literal SIMD candidates remain exact")
    func interiorRareByteLiteralSIMDCandidatesRemainExact() throws {
        let root = try TemporaryDirectory()
        let literal = "theta qeta eta"
        let miss = "theta zeta eta"
    ...
    func quietFixedASCIIClassRegexMatchesRecursively() throws {
        ...
        let noCandidateFilesWithMatchesOutput = try runExecutableData([
            "-l",
            "[A-Z]{5}",
        ...
        let binaryNoMatchFilesWithMatchesOutput = try runExecutableData([
            "-l",
            "[A-Z]{5}",
        ...
        let jsonStatsQuietOutput = try runExecutableData([
            "--json",
            "--stats",
            "-q",
            pattern,
        ...
        let jsonStatsQuietText = String(decoding: jsonStatsQuietOutput, as: UTF8.self)
        #expect(jsonStatsQuietText.contains(#""bytes_printed":0"#))
        #expect(jsonStatsQuietText.contains(#""bytes_searched":98"#))
        #expect(jsonStatsQuietText.contains(#""matched_lines":1"#))
        #expect(jsonStatsQuietText.contains(#""matches":2"#))
        #expect(jsonStatsQuietText.contains(#""searches":2"#))
        #expect(jsonStatsQuietText.contains(#""searches_with_match":1"#))
    ...
    func darwinExecutableLiteralPreflightDenseLines() throws {
        ...
        let jsonLineRegexpNoMatchSummary = try runExecutableResult([
            "--no-config",
            "--json",
            "-x",
            "missingliteral",
        ...
        let jsonOnlyMatchingNoMatchSummary = try runExecutableResult([
            "--no-config",
            "--json",
            "-o",
            "missingliteral",
        ...
        let jsonVimgrepNoMatchSummary = try runExecutableResult([
            "--no-config",
            "--json",
            "--vimgrep",
            "missingliteral",
        ...
        let fixedJsonFilesWithMatchesNoMatch = try runExecutableResult([
            "--no-config",
            "--json",
            "-l",
            "[A-Z]{5}",
        ...
        let fixedJsonFilesWithMatchesMatch = try runExecutableResult([
            "--no-config",
            "--json",
            "-l",
            "[A-Z]{5}",
        ...
        let fixedJsonFilesWithoutMatchNoMatch = try runExecutableResult([
            "--no-config",
            "--json",
            "--files-without-match",
            "[A-Z]{5}",
        ...
        let fixedJsonFilesWithoutMatchMatch = try runExecutableResult([
            "--no-config",
            "--json",
            "--files-without-match",
            "[A-Z]{5}",
        ...
        let fixedJsonCountNoMatch = try runExecutableResult([
            "--no-config",
            "--json",
            "-c",
            "[A-Z]{5}",
        ...
        let fixedJsonCountMatchesNoMatch = try runExecutableResult([
            "--no-config",
            "--json",
            "--count-matches",
            "[A-Z]{5}",
        ...
        let fixedLineMatch = try runExecutableResult([
            "--no-config",
            "[A-Z]{5}",
            root.path("summary-match.txt"),
        ])
        ...
        let fixedPrefixedNumberedLineMatch = try runExecutableResult([
            "--no-config",
            "--with-filename",
            "-n",
            "[A-Z]{5}",
        ...
        let fixedOnlyMatchingMatch = try runExecutableResult([
            "--no-config",
            "-o",
            "[A-Z]{5}",
            root.path("summary-match.txt"),
        ])
        let fixedNumberedOnlyMatchingMatch = try runExecutableResult([
            "--no-config",
            "-n",
            "-o",
            "[A-Z]{5}",
        ...
        let fixedPrefixedNumberedOnlyMatchingMatch = try runExecutableResult([
            "--no-config",
            "--with-filename",
            "-n",
            "-o",
        ...
        let fixedVimgrepOnlyMatchingMatch = try runExecutableResult([
            "--no-config",
            "--vimgrep",
            "-o",
            "[A-Z]{5}",
        ...
        let jsonCountMatchesIncludeZeroNoMatch = try runExecutableResult([
            "--no-config",
            "--json",
            "--count-matches",
            "--include-zero",
        ...
        let jsonStatsCountIncludeZeroNoMatchSummary = try runExecutableResult([
            "--no-config",
            "--json",
            "--stats",
            "-c",
        ...
        let fixedStatsQuietMatchSummary = try runExecutableResult([
            "--no-config",
            "--stats",
            "-q",
            "[A-Z]{5}",
        ...
        let statsCrlfCountIncludeZeroNoMatchSummary = try runExecutableResult([
            "--no-config",
            "--stats",
            "--crlf",
            "-c",
        ...
        let statsOnlyMatchingNoMatchSummary = try runExecutableResult([
            "--no-config",
            "--stats",
            "-o",
            "missingliteral",
        ...
        for result in [
            ...
            #expect(result.status == 1)
            #expect(result.stderr.isEmpty)
            #expect(result.stdout == expectedZeroCountStatsNoMatchSummary)
        }
        ...
        #expect(fixedJsonFilesWithoutMatchNoMatch.status == 0)
        #expect(fixedJsonFilesWithoutMatchNoMatch.stderr.isEmpty)
        #expect(fixedJsonFilesWithoutMatchNoMatch.stdout == expectedFixedPathNoMatch)
        for result in [
        ...
        #expect(fixedJsonFilesWithMatchesMatch.status == 0)
        #expect(fixedJsonFilesWithMatchesMatch.stderr.isEmpty)
        #expect(fixedJsonFilesWithMatchesMatch.stdout == expectedFixedMatchPath)
        for result in [
            jsonFilesWithoutMatchMatch,
            jsonFilesWithoutMatchIgnoreCaseWordMatch,
            fixedJsonFilesWithoutMatchMatch,
        ] {
            #expect(result.status == 1)
            #expect(result.stderr.isEmpty)
        ...
        #expect(fixedStatsQuietMatchSummary.status == 0)
        #expect(fixedStatsQuietMatchSummary.stderr.isEmpty)
        #expect(fixedStatsQuietMatchSummary.stdout == expectedStatsMatchSummary(matches: 1, matchedLines: 1))
        ...
        for result in [
            ...
            fixedJsonFilesWithMatchesNoMatch,
            jsonCountNoMatch,
            jsonCountMatchesNoMatch,
            fixedJsonCountNoMatch,
            fixedJsonCountMatchesNoMatch,
        ] {
            #expect(result.status == 1)
            #expect(result.stderr.isEmpty)
            #expect(result.stdout.isEmpty)
        ...
        #expect(fixedPrefixedNumberedLineMatch.status == 0)
        #expect(fixedPrefixedNumberedLineMatch.stderr.isEmpty)
        #expect(fixedPrefixedNumberedLineMatch.stdout == Data("\(root.path("summary-match.txt")):3:ALPHA\n".utf8))
        #expect(fixedOnlyMatchingMatch.status == 0)
        #expect(fixedOnlyMatchingMatch.stderr.isEmpty)
        #expect(fixedOnlyMatchingMatch.stdout == Data("ALPHA\n".utf8))
        #expect(fixedNumberedOnlyMatchingMatch.status == 0)
        #expect(fixedNumberedOnlyMatchingMatch.stderr.isEmpty)
        #expect(fixedNumberedOnlyMatchingMatch.stdout == Data("3:ALPHA\n".utf8))
        ...
        let rareAnchorNumberedNoMatchOutput = try runExecutableResult([
            "-n",
            "absentliteral",
            root.path("rare-anchor-false-positive.txt"),
        ])
        #expect(rareAnchorNumberedNoMatchOutput.stdout.isEmpty)
        #expect(rareAnchorNumberedNoMatchOutput.stderr.isEmpty)
        #expect(rareAnchorNumberedNoMatchOutput.status == 1)

        let rareAnchorPrefixedNoMatchOutput = try runExecutableResult([
            "-H",
            "absentliteral",
            root.path("rare-anchor-false-positive.txt"),
        ])
        #expect(rareAnchorPrefixedNoMatchOutput.stdout.isEmpty)
        #expect(rareAnchorPrefixedNoMatchOutput.stderr.isEmpty)
        #expect(rareAnchorPrefixedNoMatchOutput.status == 1)

        let rareAnchorHeadingNoMatchOutput = try runExecutableResult([
            "--heading",
            "--with-filename",
            "absentliteral",
            root.path("rare-anchor-false-positive.txt"),
        ])
        #expect(rareAnchorHeadingNoMatchOutput.stdout.isEmpty)
        #expect(rareAnchorHeadingNoMatchOutput.stderr.isEmpty)
        #expect(rareAnchorHeadingNoMatchOutput.status == 1)
        ...
        let rareAnchorMultiLiteralLineNoMatchOutput = try runExecutableResult([
            "-e",
            "ALPHA",
            "-e",
            "BRAVO",
        ...
        #expect(rareAnchorMultiLiteralLineNoMatchOutput.stdout.isEmpty)
        #expect(rareAnchorMultiLiteralLineNoMatchOutput.stderr.isEmpty)
        #expect(rareAnchorMultiLiteralLineNoMatchOutput.status == 1)

        let rareAnchorMultiLiteralCountNoMatchOutput = try runExecutableResult([
            "-c",
            "-e",
            "ALPHA",
            "-e",
        ...
        #expect(rareAnchorMultiLiteralCountNoMatchOutput.stdout.isEmpty)
        #expect(rareAnchorMultiLiteralCountNoMatchOutput.stderr.isEmpty)
        #expect(rareAnchorMultiLiteralCountNoMatchOutput.status == 1)

        let rareAnchorMultiLiteralIncludeZeroCountOutput = try runExecutableResult([
            "-c",
            "--include-zero",
            "-e",
            "ALPHA",
        ...
        #expect(rareAnchorMultiLiteralIncludeZeroCountOutput.stdout == Data("0\n".utf8))
        #expect(rareAnchorMultiLiteralIncludeZeroCountOutput.stderr.isEmpty)
        #expect(rareAnchorMultiLiteralIncludeZeroCountOutput.status == 1)
        ...
        for (quietArguments, expectedStatus) in [
            ...
            (["-q", "-e", "needle", "-e", "tail", root.path("quiet-no-match.txt"), root.path("dense.txt")], Int32(0)),
            (["-q", "-i", "-e", "NEEDLE", "-e", "ABSENT", root.path("quiet-no-match.txt"), root.path("dense.txt")], Int32(0)),
            (["-q", "-w", "-e", "needle", "-e", "absent", root.path("quiet-no-match.txt"), root.path("dense.txt")], Int32(0)),
            (["-q", "-i", "-w", "-e", "NEEDLE", "-e", "ABSENT", root.path("quiet-no-match.txt"), root.path("dense.txt")], Int32(0)),
            (["-q", "-x", "-e", "needle needle needle", "-e", "tail needle", root.path("quiet-no-match.txt"), root.path("dense.txt")], Int32(0)),
        ...
        let pathOnlyCases: [([String], Data, Int32)] = [
            ...
            (["-l", "-e", "needle", "-e", "tail", root.path("quiet-no-match.txt"), root.path("dense.txt")], Data("\(root.path("dense.txt"))\n".utf8), Int32(0)),
            (["-l", "-i", "-e", "NEEDLE", "-e", "ABSENT", root.path("quiet-no-match.txt"), root.path("dense.txt")], Data("\(root.path("dense.txt"))\n".utf8), Int32(0)),
            (["-l", "-w", "-e", "needle", "-e", "absent", root.path("quiet-no-match.txt"), root.path("dense.txt")], Data("\(root.path("dense.txt"))\n".utf8), Int32(0)),
            (["-l", "-i", "-w", "-e", "NEEDLE", "-e", "ABSENT", root.path("quiet-no-match.txt"), root.path("dense.txt")], Data("\(root.path("dense.txt"))\n".utf8), Int32(0)),
            (["-l", "-x", "-e", "needle needle needle", "-e", "tail needle", root.path("quiet-no-match.txt"), root.path("dense.txt")], Data("\(root.path("dense.txt"))\n".utf8), Int32(0)),
            ...
            (["--files-without-match", "-e", "needle", "-e", "tail", root.path("quiet-no-match.txt"), root.path("dense.txt")], Data("\(root.path("quiet-no-match.txt"))\n".utf8), Int32(0)),
            (["--files-without-match", "-i", "-e", "NEEDLE", "-e", "ABSENT", root.path("quiet-no-match.txt"), root.path("dense.txt")], Data("\(root.path("quiet-no-match.txt"))\n".utf8), Int32(0)),
            (["--files-without-match", "-w", "-e", "needle", "-e", "absent", root.path("quiet-no-match.txt"), root.path("dense.txt")], Data("\(root.path("quiet-no-match.txt"))\n".utf8), Int32(0)),
            (["--files-without-match", "-i", "-w", "-e", "NEEDLE", "-e", "ABSENT", root.path("quiet-no-match.txt"), root.path("dense.txt")], Data("\(root.path("quiet-no-match.txt"))\n".utf8), Int32(0)),
            (["--files-without-match", "-x", "-e", "needle needle needle", "-e", "tail needle", root.path("quiet-no-match.txt"), root.path("dense.txt")], Data("\(root.path("quiet-no-match.txt"))\n".utf8), Int32(0)),
            ...
            (["--no-config", "--files-without-match", "missing", root.path("dense.txt")], Data("\(root.path("dense.txt"))\n".utf8), Int32(0)),
        ...
        let countCases: [([String], Data, Int32)] = [
            ...
            (["-c", "-e", "needle", "-e", "tail", root.path("quiet-no-match.txt"), root.path("dense.txt")], Data("\(root.path("dense.txt")):3\n".utf8), Int32(0)),
            (["-x", "-c", "-e", "needle needle needle", "-e", "tail needle", root.path("quiet-no-match.txt"), root.path("dense.txt")], Data("\(root.path("dense.txt")):2\n".utf8), Int32(0)),
            (["-i", "-x", "-c", "-e", "NEEDLE NEEDLE NEEDLE", "-e", "TAIL NEEDLE", root.path("quiet-no-match.txt"), root.path("dense.txt")], Data("\(root.path("dense.txt")):3\n".utf8), Int32(0)),
            ...
            (["--include-zero", "-c", "-e", "needle", "-e", "tail", root.path("quiet-no-match.txt"), root.path("dense.txt")], Data("\(root.path("quiet-no-match.txt")):0\n\(root.path("dense.txt")):3\n".utf8), Int32(0)),
            (["--include-zero", "-x", "-c", "-e", "needle needle needle", "-e", "tail needle", root.path("quiet-no-match.txt"), root.path("dense.txt")], Data("\(root.path("quiet-no-match.txt")):0\n\(root.path("dense.txt")):2\n".utf8), Int32(0)),
            ...
            (["--include-zero", "--count-matches", "-e", "needle", "-e", "tail", root.path("quiet-no-match.txt"), root.path("dense.txt")], Data("\(root.path("quiet-no-match.txt")):0\n\(root.path("dense.txt")):6\n".utf8), Int32(0)),
            (["--include-zero", "--count-matches", "-x", "-e", "needle needle needle", "-e", "tail needle", root.path("quiet-no-match.txt"), root.path("dense.txt")], Data("\(root.path("quiet-no-match.txt")):0\n\(root.path("dense.txt")):2\n".utf8), Int32(0)),
            ...
            (["--include-zero", "-c", "missing", root.path("quiet-no-match.txt"), root.path("dense.txt")], Data("\(root.path("quiet-no-match.txt")):0\n\(root.path("dense.txt")):0\n".utf8), Int32(1)),
        ...
        let utf8EncodingMultiWordOutput = try runExecutableData([
            "--encoding=utf-8",
            "-w",
            "-e",
            "needle",
        ...
        #expect(utf8EncodingMultiWordOutput == Data("""
        needle needle needle
        quiet line
        NEEDLE needle Needle
        tail needle
        ...
        let utf8EncodingIgnoreCaseWordOutput = try runExecutableData([
            "--encoding=utf-8",
            "-i",
            "-w",
            "NEEDLE",
        ...
        #expect(utf8EncodingIgnoreCaseWordOutput == caseInsensitiveWordOutput)

        let utf8EncodingInvalidWordOutput = try runExecutableData([
            "--encoding=utf-8",
            "-w",
            "needle",
            root.path("encoding-none-invalid.txt"),
        ], fixture: {})
        #expect(utf8EncodingInvalidWordOutput == utf8EncodingInvalidLineOutput)
        ...
        let disabledEncodingWordOutput = try runExecutableData([
            "--encoding=none",
            "-w",
            "needle",
            root.path("dense.txt"),
        ], fixture: {})
        #expect(disabledEncodingWordOutput == output)

        let disabledEncodingMultiWordOutput = try runExecutableData([
            "--encoding=none",
            "-w",
            "-e",
            "needle",
        ...
        #expect(disabledEncodingIgnoreCaseWordOutput == caseInsensitiveWordOutput)
        ...
        let encodingNoneWordOnlyMatchingVimgrepOutput = try runExecutableData([
            "--encoding=none",
            "--vimgrep",
            "-w",
            "-o",
        ...
        #expect(encodingNoneWordOnlyMatchingVimgrepOutput == Data("""
        \(root.path("dense.txt")):1:1:needle
        \(root.path("dense.txt")):1:8:needle
        \(root.path("dense.txt")):1:15:needle
        \(root.path("dense.txt")):2:1:quiet
        \(root.path("dense.txt")):3:8:needle
        \(root.path("dense.txt")):4:6:needle

        """.utf8))

        let utf8EncodingIgnoreCaseWordOnlyMatchingVimgrepOutput = try runExecutableData([
            "--encoding=utf-8",
            "--ignore-case",
            "--vimgrep",
            "--word-regexp",
        ...
        #expect(utf8EncodingIgnoreCaseWordOnlyMatchingVimgrepOutput == Data("""
        \(root.path("dense.txt")):1:1:needle
        \(root.path("dense.txt")):1:8:needle
        \(root.path("dense.txt")):1:15:needle
        \(root.path("dense.txt")):2:1:quiet
        \(root.path("dense.txt")):3:1:NEEDLE
        \(root.path("dense.txt")):3:8:needle
        \(root.path("dense.txt")):3:15:Needle
        \(root.path("dense.txt")):4:6:needle

        """.utf8))

        let utf8EncodingWordOnlyMatchingVimgrepUnicodeFallback = try runExecutableData([
            "--encoding=utf-8",
            "--ignore-case",
            "--vimgrep",
            "--word-regexp",
        ...
        #expect(utf8EncodingWordOnlyMatchingVimgrepUnicodeFallback == Data(
            "\(root.path("unicode-word-ci.txt")):2:5:NEEDLE\n\(root.path("unicode-word-ci.txt")):3:1:NEEDLE\n".utf8
        ))
        ...
        let exactLineCases: [([String], Data)] = [
            ...
            (["-b", "-x", "needle", root.path("exact.txt")], Data("0:needle\n18:needle\n".utf8)),
            (["--column", "-x", "needle", root.path("exact.txt")], Data("1:1:needle\n3:1:needle\n".utf8)),
            (["-n", "-b", "--column", "-x", "needle", root.path("exact.txt")], Data("1:1:0:needle\n3:1:18:needle\n".utf8)),
            ...
            (["--encoding=none", "-x", "needle", root.path("exact.txt")], Data("needle\nneedle\n".utf8)),
            (["--encoding=none", "-n", "-x", "needle", root.path("exact.txt")], Data("1:needle\n3:needle\n".utf8)),
            (["--encoding=none", "-i", "-x", "NEEDLE|LAST", root.path("exact.txt")], Data("needle\nneedle\nlast\n".utf8)),
            (["--encoding=none", "-n", "-i", "-x", "NEEDLE|LAST", root.path("exact.txt")], Data("1:needle\n3:needle\n5:last\n".utf8)),
            (["--encoding=utf-8", "-i", "-x", "NEEDLE|LAST", root.path("exact.txt")], Data("needle\nneedle\nlast\n".utf8)),
            (["--encoding=none", "-o", "-x", "needle", root.path("exact.txt")], Data("needle\nneedle\n".utf8)),
            (["--encoding=none", "-n", "-o", "-x", "needle", root.path("exact.txt")], Data("1:needle\n3:needle\n".utf8)),
            (["--encoding=none", "-o", "-i", "-x", "NEEDLE|LAST", root.path("exact.txt")], Data("needle\nneedle\nlast\n".utf8)),
            ...
            (["--vimgrep", "-i", "-x", "NEEDLE|LAST", root.path("exact.txt")], Data("\(root.path("exact.txt")):1:1:needle\n\(root.path("exact.txt")):3:1:needle\n\(root.path("exact.txt")):5:1:last\n".utf8)),
            (["--vimgrep", "--no-column", "-x", "needle", root.path("exact.txt")], Data("\(root.path("exact.txt")):1:needle\n\(root.path("exact.txt")):3:needle\n".utf8)),
            (["--vimgrep", "--no-column", "-i", "-x", "NEEDLE|LAST", root.path("exact.txt")], Data("\(root.path("exact.txt")):1:needle\n\(root.path("exact.txt")):3:needle\n\(root.path("exact.txt")):5:last\n".utf8)),
            ...
            (["--vimgrep", "-b", "-i", "-x", "NEEDLE|LAST", root.path("exact.txt")], Data("\(root.path("exact.txt")):1:1:0:needle\n\(root.path("exact.txt")):3:1:18:needle\n\(root.path("exact.txt")):5:1:37:last\n".utf8)),
        ...
        #expect(deferredShortFollowNoConfigVimgrepOutput == leadingNoConfigVimgrepOutput)
        ...
        let deferredTypeNoConfigVimgrepOutput = try runExecutableData([
            "-t",
            "rust",
            "--vimgrep",
            "--heading",
        ...
        #expect(deferredTypeNoConfigVimgrepOutput == leadingNoConfigVimgrepOutput)

        let deferredInlineTypeNoConfigVimgrepOutput = try runExecutableData([
            "--type=rust",
            "--vimgrep",
            "--heading",
            "--no-config",
        ...
        #expect(deferredInlineTypeNoConfigVimgrepOutput == leadingNoConfigVimgrepOutput)

        let deferredTypeAddNoConfigVimgrepOutput = try runExecutableData([
            "--type-add",
            "foo:*.txt",
            "-t",
            "foo",
        ...
        #expect(deferredTypeAddNoConfigVimgrepOutput == leadingNoConfigVimgrepOutput)

        let deferredInlineTypeNotNoConfigVimgrepOutput = try runExecutableData([
            "-Trust",
            "--vimgrep",
            "--heading",
            "--no-config",
        ...
        #expect(deferredInlineTypeNotNoConfigVimgrepOutput == leadingNoConfigVimgrepOutput)
