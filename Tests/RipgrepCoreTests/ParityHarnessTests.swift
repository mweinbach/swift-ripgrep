...
"""
    return [
        ...
        ParityCase(name: "feature::greek_script_recursive_count", fixture: greekScriptFixture, arguments: ["--sort", "path", "-c", #"\p{Greek}"#, "."]),
        ParityCase(name: "feature::greek_script_recursive_ignore_case_count", fixture: greekScriptFixture, arguments: ["--sort", "path", "-i", "-c", #"\p{Greek}"#, "."]),
        ParityCase(name: "feature::greek_script_recursive_count_matches_runs", fixture: greekScriptFixture, arguments: ["--sort", "path", "--count-matches", #"\p{Greek}+"#, "."]),
        ParityCase(name: "feature::greek_script_recursive_files_with_matches", fixture: greekScriptFixture, arguments: ["--sort", "path", "-l", #"\p{Greek}"#, "."]),
        ParityCase(name: "feature::greek_script_recursive_stats_files_with_matches", fixture: greekScriptFixture, arguments: ["--sort", "path", "--stats", "-l", #"\p{Greek}"#, "."]),
        ParityCase(name: "feature::greek_script_recursive_stats_quiet", fixture: greekScriptFixture, arguments: ["--sort", "path", "--stats", "-q", #"\p{Greek}"#, "."]),
        ParityCase(name: "feature::greek_script_recursive_json_quiet", fixture: greekScriptFixture, arguments: ["--sort", "path", "--json", "-q", #"\p{Greek}"#, "."]),
        ParityCase(name: "feature::greek_script_recursive_json_stats_quiet", fixture: greekScriptFixture, arguments: ["--sort", "path", "--json", "--stats", "-q", #"\p{Greek}"#, "."]),
...
private func miscParityCases() -> [ParityCase] {
    ...
    return [
        ...
        ParityCase(name: "misc::word_whitespace_sequence_no_mmap_count", fixture: wordWhitespaceSequenceFixture, arguments: ["--no-mmap", "-c", #"\w{5}\s+\w{5}\s+\w{5}\s+\w{5}\s+\w{5}"#, "words.txt"]),
        ParityCase(name: "misc::word_whitespace_sequence_passthru_count", fixture: wordWhitespaceSequenceFixture, arguments: ["--passthru", "-c", #"\w{5}\s+\w{5}\s+\w{5}\s+\w{5}\s+\w{5}"#, "words.txt"]),
        ParityCase(name: "misc::word_whitespace_sequence_count_matches", fixture: wordWhitespaceSequenceFixture, arguments: ["--count-matches", #"\w{5}\s+\w{5}\s+\w{5}\s+\w{5}\s+\w{5}"#, "words.txt"]),
        ParityCase(name: "misc::word_whitespace_sequence_no_mmap_count_matches", fixture: wordWhitespaceSequenceFixture, arguments: ["--no-mmap", "--count-matches", #"\w{5}\s+\w{5}\s+\w{5}\s+\w{5}\s+\w{5}"#, "words.txt"]),
        ParityCase(name: "misc::word_whitespace_sequence_stats_count", fixture: wordWhitespaceSequenceFixture, arguments: ["--stats", "-c", #"\w{5}\s+\w{5}\s+\w{5}\s+\w{5}\s+\w{5}"#, "words.txt"]),
        ParityCase(name: "misc::word_whitespace_sequence_stats_passthru_count", fixture: wordWhitespaceSequenceFixture, arguments: ["--stats", "--passthru", "-c", #"\w{5}\s+\w{5}\s+\w{5}\s+\w{5}\s+\w{5}"#, "words.txt"]),
        ...
        ParityCase(name: "misc::word_whitespace_sequence_no_mmap_stats_count_matches", fixture: wordWhitespaceSequenceFixture, arguments: ["--no-mmap", "--stats", "--count-matches", #"\w{5}\s+\w{5}\s+\w{5}\s+\w{5}\s+\w{5}"#, "words.txt"]),
        ...
        ParityCase(name: "misc::word_whitespace_sequence_no_mmap_stats_quiet", fixture: wordWhitespaceSequenceFixture, arguments: ["--no-mmap", "--stats", "-q", #"\w{5}\s+\w{5}\s+\w{5}\s+\w{5}\s+\w{5}"#, "words.txt"]),
        ...
        ParityCase(name: "misc::word_whitespace_sequence_no_mmap_stats_files_with_matches", fixture: wordWhitespaceSequenceFixture, arguments: ["--no-mmap", "--stats", "-l", #"\w{5}\s+\w{5}\s+\w{5}\s+\w{5}\s+\w{5}"#, "words.txt"]),
        ParityCase(name: "misc::word_whitespace_sequence_stats_context_files_with_matches", fixture: wordWhitespaceSequenceFixture, arguments: ["--stats", "-A1", "-l", #"\w{5}\s+\w{5}\s+\w{5}\s+\w{5}\s+\w{5}"#, "words.txt"]),
        ...
        ParityCase(name: "misc::word_whitespace_sequence_context_files_with_matches", fixture: wordWhitespaceSequenceFixture, arguments: ["-A1", "-l", #"\w{5}\s+\w{5}\s+\w{5}\s+\w{5}\s+\w{5}"#, "words.txt"]),
        ...
        ParityCase(name: "misc::word_whitespace_sequence_no_mmap_files_with_matches", fixture: wordWhitespaceSequenceFixture, arguments: ["--no-mmap", "-l", #"\w{5}\s+\w{5}\s+\w{5}\s+\w{5}\s+\w{5}"#, "words.txt"]),
        ...
        ParityCase(name: "misc::json_quiet_ascii_fixed_class", fixture: asciiFixedClassFixture, arguments: ["--json", "-q", "[A-Z][a-z]{8}[0-9]{3}", "."]),
        ParityCase(name: "misc::json_stats_quiet_ascii_fixed_class", fixture: asciiFixedClassFixture, arguments: ["--json", "--stats", "-q", "[A-Z][a-z]{8}[0-9]{3}", "."]),
        ...
        ParityCase(name: "misc::context_files_with_matches_ascii_fixed_class", fixture: asciiFixedClassFixture, arguments: ["-A1", "-l", "[A-Z][a-z]{8}[0-9]{3}", "."]),
        ...
        ParityCase(name: "misc::stats_context_files_with_matches_ascii_fixed_class", fixture: asciiFixedClassFixture, arguments: ["--stats", "-A1", "-l", "[A-Z][a-z]{8}[0-9]{3}", "."]),
        ...
        ParityCase(name: "misc::passthru_count_ascii_fixed_class", fixture: asciiFixedClassFixture, arguments: ["--passthru", "-c", "[A-Z][a-z]{8}[0-9]{3}", "."]),
        ...
        ParityCase(name: "misc::replacement_count_matches_ascii_fixed_class", fixture: asciiFixedClassFixture, arguments: ["-r", "X", "--count-matches", "[A-Z][a-z]{8}[0-9]{3}", "."]),
        ...
        ParityCase(name: "misc::stats_quiet_ascii_fixed_class", fixture: asciiFixedClassFixture, arguments: ["--stats", "-q", "[A-Z][a-z]{8}[0-9]{3}", "."]),
        ...
        ParityCase(name: "misc::json_quiet_max_count_ascii_fixed_class", fixture: asciiFixedClassMaxCountFixture, arguments: ["--json", "-q", "-m1", "[A-Z][a-z]{8}[0-9]{3}", "max.txt"]),
        ParityCase(name: "misc::max_count_count_ascii_fixed_class", fixture: asciiFixedClassMaxCountFixture, arguments: ["-c", "-m1", "[A-Z][a-z]{8}[0-9]{3}", "max.txt"]),
        ParityCase(name: "misc::max_count_count_matches_ascii_fixed_class", fixture: asciiFixedClassMaxCountFixture, arguments: ["--count-matches", "-m1", "[A-Z][a-z]{8}[0-9]{3}", "max.txt"]),
        ParityCase(name: "misc::stats_max_count_count_ascii_fixed_class", fixture: asciiFixedClassMaxCountFixture, arguments: ["--stats", "-c", "-m1", "[A-Z][a-z]{8}[0-9]{3}", "max.txt"]),
        ParityCase(name: "misc::max_count_files_with_matches_ascii_fixed_class", fixture: asciiFixedClassMaxCountFixture, arguments: ["-l", "-m1", "[A-Z][a-z]{8}[0-9]{3}", "max.txt"]),
        ParityCase(name: "misc::max_count_files_without_match_ascii_fixed_class", fixture: asciiFixedClassMaxCountFixture, arguments: ["--files-without-match", "-m1", "[A-Z][a-z]{8}[0-9]{3}", "max.txt"]),
        ParityCase(name: "misc::max_count_quiet_ascii_fixed_class", fixture: asciiFixedClassMaxCountFixture, arguments: ["-q", "-m1", "[A-Z][a-z]{8}[0-9]{3}", "max.txt"]),
        ...
        ParityCase(name: "misc::max_columns_ascii_fixed_class", fixture: asciiFixedClassFixture, arguments: ["--max-columns", "10", "[A-Z][a-z]{8}[0-9]{3}", "match.txt"]),
        ParityCase(name: "misc::max_columns_preview_ascii_fixed_class", fixture: asciiFixedClassFixture, arguments: ["--max-columns", "10", "--max-columns-preview", "[A-Z][a-z]{8}[0-9]{3}", "match.txt"]),
        ParityCase(name: "misc::max_columns_column_ascii_fixed_class", fixture: asciiFixedClassFixture, arguments: ["--max-columns", "10", "--column", "[A-Z][a-z]{8}[0-9]{3}", "match.txt"]),
        ParityCase(name: "misc::max_columns_only_matching_ascii_fixed_class", fixture: asciiFixedClassFixture, arguments: ["--max-columns", "10", "-o", "[A-Z][a-z]{8}[0-9]{3}", "match.txt"]),
        ParityCase(name: "misc::stats_max_columns_ascii_fixed_class", fixture: asciiFixedClassFixture, arguments: ["--stats", "--max-columns", "10", "[A-Z][a-z]{8}[0-9]{3}", "match.txt"]),
